...
/* 54 */       return true;
/*    */     }
/* 57 */     playerMsg("MasterFreedomMod for 'Master Freedom', the all-op server.", ChatColor.GOLD);
...
/* 67 */     playerMsg("Created by reuben4545 and ASMaster.", ChatColor.GOLD);
/* 68 */     playerMsg("Visit " + ChatColor.AQUA + "http://masterfreedom.boards.net/" + ChatColor.GREEN + " for our forums.", ChatColor.GREEN);
/*    */     
/* 70 */     return true;
/*    */   }
/*    */ }
